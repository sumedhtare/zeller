...
export const virtualDeviceNames = [
  'AC',
  'Curtain',
  'Music',
  'Projector',
...
export const getRoomImage = (name: RoomName) => {
  switch (name) {
    ...
    case 'garden':
      return require('../../assets/images/rooms/garden.png');
    default:
      return require('../../assets/images/rooms/sofa.png');
  }
};
